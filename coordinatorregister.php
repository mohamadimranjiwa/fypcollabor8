...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password !== $repeat_password) {
        ...
        // Prepare SQL to insert coordinator data
        $sql = "INSERT INTO coordinators (username, email, password) VALUES (?, ?, ?)";
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                $message = "<div class='success-message'>Registration successful! You can now <a href='coordinatorlogin.php'>log in</a>.</div>";
            } else {
                $message = "<div class='error-message'>An error occurred: " . htmlspecialchars($stmt->error) . "</div>";
                // Note: This might indicate a duplicate email since email is UNIQUE in the table
            }
                ...
                <div class="row">
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="">
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="coordinatorlogin.php">Already have an account? Login!</a>
                                </div>
                            </form>
                                </div>
                            </div>
